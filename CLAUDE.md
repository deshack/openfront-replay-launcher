...
3. **`.github/workflows/prebuild-release.yml`** — Polls OpenFrontIO releases daily; pre-builds images for new tags and pushes to `ghcr.io/<GHCR_OWNER>/openfront:<sha>`.

## Key implementation constraints

- Docker image ref pattern: `ghcr.io/<GHCR_OWNER>/openfront:<sha>`
